...
class resNet(torch.nn.Module):
    ...
    def __init__(self):
        ...
        self.layer1 = build_layer(BottleNeck, input_channels=64, planes=64, num_blocks=layers[0], stride=1)
        self.layer2 = build_layer(BottleNeck, input_channels=256, planes=128, num_blocks=layers[1], stride=2)
        self.layer3 = build_layer(BottleNeck, input_channels=512, planes=256, num_blocks=layers[2], stride=2)
        self.layer4 = build_layer(BottleNeck, input_channels=1024, planes=512, num_blocks=layers[3], stride=2)
